...
wifi_sniffer_init(void)
{
	...
	ESP_ERROR_CHECK( esp_wifi_set_country(WIFI_COUNTRY_EU) ); /* country Europe, channel range [1, 13] */    	
...
wifi_sniffer_packet_handler(void* buff, wifi_promiscuous_pkt_type_t type)
{
	...
	printf("PACKET TYPE=%s, CHAN=%02d, RSSI=%02d, ADDR1=%02x:%02x:%02x:%02x:%02x:%02x, ADDR2=%02x:%02x:%02x:%02x:%02x:%02x, ADDR3=%02x:%02x:%02x:%02x:%02x:%02x\n", 
