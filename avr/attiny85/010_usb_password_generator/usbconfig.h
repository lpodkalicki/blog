...
extern void usbEventResetReady(void); // From: http://vusb.wikidot.com/examples
#endif
 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xDE, 0xFA /* = 0x05dc = 1500 */
 ...
 */
#define USB_CFG_VENDOR_NAME     'b', 'l', 'o', 'g', '.',  'p', 'o', 'd', 'k', 'a', 'l', 'i', 'c', 'k', 'i', '.', 'c', 'o', 'm'
 ...
 */
#define USB_CFG_SERIAL_NUMBER   '0','x','A', 'B', 'C', 'D', 'E', 'F'
